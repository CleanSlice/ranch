...
dotenv -e .env.dev -- npx prisma db push --accept-data-loss 2>/dev/null || npx prisma db push 2>/dev/null
dotenv -e .env.dev -- npx prisma generate 2>/dev/null || npx prisma generate 2>/dev/null
cd ..
